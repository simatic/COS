...
** Exécution de la phase 2 de COS
...
#+END_SRC
** Exploitation des fichiers générés par COS (en phase 2)
...
intéressantes qu'avant ! N'hésitez pas à nous faire des retours sur
 [[https://github.com/simatic/COS][github]] ou à [[mailto:Michel.Simatic@telecom-sudparis.eu][Michel.Simatic@telecom-sudparis.eu]].
